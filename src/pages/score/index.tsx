...
const ScorePage = () => {
  ...
  const fetchData = async () => {
    const response = await axiosJWT.get(`${process.env.NEXT_PUBLIC_BASE_URL}/mardiyuana-student/score-course/score-course-student${academicYearId ? `?academicYearId=${academicYearId}` : ""}`, {
