...
const Reminder: React.FC<ReminderProps> = ({ initialCourseData }) => {
  ...
  const fetchData = async () => {
    const response = await axiosJWT.get(`${process.env.NEXT_PUBLIC_BASE_URL}/mardiyuana-student/course/reminder-courses?courseSectionId=${courseSectionId}&id=${enrollmentId}`, {
